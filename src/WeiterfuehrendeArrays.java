	...
	public static void main(String[] args) {
		...
		switch (sUserEingabe.toUpperCase()) 
		{
			...
			case "L":
				...
				/*Set set = schnittstellen.entrySet();
				 ...
				 break;
			case "N":
				String bezeichnung=JOptionPane.showInputDialog("Geben Sie bitte die Schnittstellenbezeichnung ein: ");
				String speed = null;
					...
					JOptionPane.showMessageDialog(null, "Diese Schnittstelle existiert bereits");
						...
						speed=JOptionPane.showInputDialog("Geben Sie bitte die Bandbreite in MBit/s ein: ");
						schnittstellen.put(bezeichnung,speed);
					}					
				break;
			case "E":
				bezeichnung=JOptionPane.showInputDialog("Geben Sie bitte die Schnittstellenbezeichnung ein: ");
					if (!schnittstellen.containsKey(bezeichnung)) 
					{
						System.out.println(sUserEingabe);
